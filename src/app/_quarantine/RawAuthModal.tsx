...
type RawAuthModalProps = {
  isOpen: boolean;
  onClose?: () => void;
  onSignUp?: (email: string, password: string) => void;
  onSignIn?: (email: string, password: string) => void;
  /** Optional error message from auth API (e.g. invalid password) */
  error?: string | null;
};

export default function RawAuthModal({
  isOpen,
  onClose,
  onSignUp,
  onSignIn,
    ...
    <>
      ...
      >
        ...
        >
          ...
          {errorProp && (
            <p className="Comp_Auth_Error text-cardzzz-accent font-satoshi text-[14px] text-center w-full" role="alert">
              {errorProp}
            </p>
          )}
