...
type RawActivateModalProps = {
  isOpen: boolean;
  onClose?: () => void;
  onActivate?: () => void;
};

export default function RawActivateModal({
  isOpen,
  onClose,
  onActivate,
}: RawActivateModalProps) {
    ...
    <>
      ...
      >
        ...
        <div className="Comp_Activate_Modal flex flex-col items-center gap-[15px] w-full max-w-[500px] pt-[30px] md:pt-[20px] pb-[30px] md:pb-[15px] pl-[30px] md:pl-[15px] pr-[30px] md:pr-[15px] rounded-[30px] bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl relative z-[60]">
          ...
          <h1
            id="activate-heading"
            className="Comp_Activate_Heading text-cardzzz-cream text-center font-roundo font-bold text-[24px] md:text-[28px] leading-normal mb-0"
          >
