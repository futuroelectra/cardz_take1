...
export default function RawSettings() {
  ...
  const [notificationSettings, setNotificationSettings] = useState({
    ...
    dreamCardReminders: true,
    subscriptionUpdates: false,
  });

  // Form validation
  const isProfileFormValid = profileData.name.trim() !== "" && profileData.email.trim() !== "";
  ...
  const handleSubscribe = () => {
    setIsPremium(true);
    console.log("Subscribed to premium");
  ...
  const handleNotificationChange = (field: keyof typeof notificationSettings, value: boolean) => {
  ...
  return (
    <div className="Layout_settings flex flex-col w-full min-h-screen bg-gradient-to-b from-cardzzz-wine to-cardzzz-blood">
      {/* Navbar Section */}
      ...
      {/* Settings Content */}
      <div className="Section_settings_content flex flex-col items-center w-full px-[15px] py-[30px] gap-[25px] max-w-[800px] mx-auto">
        {/* Page Heading */}
        <h1 className="Comp_Settings_Heading text-cardzzz-cream text-center font-roundo font-bold text-[32px] md:text-[36px] leading-normal w-full">
          settings
        </h1>

        {/* Profile Section */}
        <div className="Comp_Settings_Section w-full flex flex-col gap-[20px] p-[25px] md:p-[30px] rounded-[20px] bg-white/10 backdrop-blur-md border border-white/20">
          <h2 className="Comp_Section_Heading text-cardzzz-cream font-roundo font-bold text-[22px] md:text-[24px] leading-normal">
            profile
          </h2>
          <form onSubmit={handleProfileSubmit} className="flex flex-col gap-[15px] w-full">
            <div className="Comp_Input_Field w-full relative">
              <label className="Comp_Label text-cardzzz-cream font-satoshi font-medium text-[14px] leading-normal mb-[8px] block">
                name
              </label>
              <input
                type="text"
            ...
            <button
              ...
              className={`Comp_Button w-full h-[54px] py-[20px] px-[10px] flex items-center justify-center gap-[10px] rounded-[16.168px] border transition-all mt-[5px] ${
                isProfileFormValid
        ...
        <div className="Comp_Settings_Section w-full flex flex-col gap-[20px] p-[25px] md:p-[30px] rounded-[20px] bg-white/10 backdrop-blur-md border border-white/20">
          ...
          <form onSubmit={handlePasswordSubmit} className="flex flex-col gap-[15px] w-full">
            <div className="Comp_Input_Field w-full relative">
              <label className="Comp_Label text-cardzzz-cream font-satoshi font-medium text-[14px] leading-normal mb-[8px] block">
                current password
              </label>
            ...
            {passwordData.newPassword !== "" && passwordData.newPassword !== passwordData.confirmPassword && (
              <p className="Comp_Error_Text text-cardzzz-accent font-satoshi font-medium text-[12px] leading-normal">
        ...
        <div className="Comp_Settings_Section w-full flex flex-col gap-[20px] p-[25px] md:p-[30px] rounded-[20px] bg-white/10 backdrop-blur-md border border-white/20">
          ...
          {isPremium ? (
            <div className="flex flex-col gap-[15px]">
              <div className="Comp_Premium_Badge flex items-center gap-[10px] p-[15px] rounded-[16px] bg-cardzzz-cream/20 border border-cardzzz-cream/30">
                <span className="text-cardzzz-cream font-roundo font-bold text-[16px] leading-normal">
                  premium member
                </span>
              </div>
              <p className="text-cardzzz-cream font-satoshi font-medium text-[14px] leading-normal">
                You have unlimited access to all your dream-cards. Enjoy unlimited messages, tests, and exports.
              </p>
              <button
                type="button"
                onClick={handleCancelSubscription}
                className="Comp_Button w-full h-[54px] py-[20px] px-[10px] flex items-center justify-center gap-[10px] rounded-[16.168px] border border-cardzzz-cream bg-transparent text-cardzzz-cream cursor-pointer hover:opacity-80 transition-all"
              >
                <span className="Label text-center font-roundo font-bold text-[19px] leading-normal relative">
                  cancel subscription
                </span>
            ...
            <div className="flex flex-col gap-[15px]">
              <p className="text-cardzzz-cream font-satoshi font-medium text-[14px] leading-normal">
                Become a premium member to enjoy unlimited access to all your dream-cards, unlimited messages, tests, and exports.
              </p>
              <button
                type="button"
                onClick={handleSubscribe}
                className="Comp_Button w-full h-[54px] py-[20px] px-[10px] flex items-center justify-center gap-[10px] rounded-[16.168px] border bg-cardzzz-cream text-cardzzz-accent border-cardzzz-cream/50 shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] cursor-pointer hover:opacity-90 transition-all"
              >
                <span className="Label text-center font-roundo font-bold text-[19px] leading-normal relative">
        ...
        <div className="Comp_Settings_Section w-full flex flex-col gap-[20px] p-[25px] md:p-[30px] rounded-[20px] bg-white/10 backdrop-blur-md border border-white/20">
          ...
          <div className="flex flex-col gap-[20px]">
            <div className="Comp_Notification_Setting flex items-center justify-between">
              <label className="text-cardzzz-cream font-satoshi font-medium text-[14px] leading-normal">
                email notifications
              </label>
              <button
                type="button"
                onClick={() => handleNotificationChange("emailNotifications", !notificationSettings.emailNotifications)}
                className={`relative w-[50px] h-[28px] rounded-full transition-all cursor-pointer ${
                  notificationSettings.emailNotifications ? "bg-cardzzz-cream" : "bg-white/20"
                }`}
              >
                <span
                  className={`absolute top-[2px] left-[2px] w-[24px] h-[24px] rounded-full bg-white transition-all ${
                    notificationSettings.emailNotifications ? "translate-x-[22px]" : "translate-x-0"
                  }`}
                />
              </button>
            </div>
            <div className="Comp_Notification_Setting flex items-center justify-between">
              ...
              <button
                ...
                className={`relative w-[50px] h-[28px] rounded-full transition-all cursor-pointer ${
                  notificationSettings.pushNotifications ? "bg-cardzzz-cream" : "bg-white/20"
                }`}
              >
                <span
                  className={`absolute top-[2px] left-[2px] w-[24px] h-[24px] rounded-full bg-white transition-all ${
                    notificationSettings.pushNotifications ? "translate-x-[22px]" : "translate-x-0"
                  }`}
                />
              </button>
            </div>
            <div className="Comp_Notification_Setting flex items-center justify-between">
              <label className="text-cardzzz-cream font-satoshi font-medium text-[14px] leading-normal">
                dream card reminders
              </label>
              <button
                type="button"
                onClick={() => handleNotificationChange("dreamCardReminders", !notificationSettings.dreamCardReminders)}
                className={`relative w-[50px] h-[28px] rounded-full transition-all cursor-pointer ${
                  notificationSettings.dreamCardReminders ? "bg-cardzzz-cream" : "bg-white/20"
                }`}
              >
                <span
                  className={`absolute top-[2px] left-[2px] w-[24px] h-[24px] rounded-full bg-white transition-all ${
                    notificationSettings.dreamCardReminders ? "translate-x-[22px]" : "translate-x-0"
                  }`}
                />
              </button>
            </div>
            <div className="Comp_Notification_Setting flex items-center justify-between">
              ...
              <button
                type="button"
                onClick={() => handleNotificationChange("subscriptionUpdates", !notificationSettings.subscriptionUpdates)}
                className={`relative w-[50px] h-[28px] rounded-full transition-all cursor-pointer ${
                  notificationSettings.subscriptionUpdates ? "bg-cardzzz-cream" : "bg-white/20"
                }`}
              >
                <span
                  className={`absolute top-[2px] left-[2px] w-[24px] h-[24px] rounded-full bg-white transition-all ${
                    notificationSettings.subscriptionUpdates ? "translate-x-[22px]" : "translate-x-0"
                  }`}
                />
              </button>
            </div>
        ...
        <div className="Comp_Settings_Section w-full flex flex-col gap-[20px] p-[25px] md:p-[30px] rounded-[20px] bg-white/10 backdrop-blur-md border border-white/20">
          ...
          <div className="flex flex-col gap-[15px]">
            ...
            <button
              ...
              className="Comp_Button w-full h-[54px] py-[20px] px-[10px] flex items-center justify-center gap-[10px] rounded-[16.168px] border border-cardzzz-accent bg-transparent text-cardzzz-accent cursor-pointer hover:opacity-80 transition-all"
            >
              <span className="Label text-center font-roundo font-bold text-[19px] leading-normal relative">
                delete account
              </span>
            </button>
            <p className="text-cardzzz-muted font-satoshi font-normal text-[12px] leading-normal text-center">
