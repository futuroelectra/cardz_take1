...
export default function RawEditorChat({ cardId }: RawEditorChatProps = {}) {
  ...
  return (
    <div className="Layout_chat flex flex-col w-full min-h-screen bg-gradient-to-b from-cardzzz-wine to-cardzzz-blood">
      ...
      <div className="Section_main_content flex flex-col md:flex-row flex-1 w-full gap-[20px] pb-[15px]">
        {/* Left Panel - Editor Canvas */}
        <div className="Section_editor_canvas flex flex-col w-full md:w-[45%] lg:w-[40%] shrink-0">
          {/* 605px alignment container - matches right side */}
          <div className="flex flex-col items-center justify-center w-full md:h-[605px] shrink-0">
            {/* Glass container wrapping iPhone - scaled proportionally to align with input field */}
            <div className="Comp_editor_container flex items-center justify-center rounded-[30px] bg-white/10 backdrop-blur-md border border-white/20 relative p-[10px] shrink-0" style={{ 
              ...
              {/* iPhone 14 screen - scaled proportionally (70% of original) */}
          ...
          <div className="Container_alignment flex flex-col w-full h-[calc(100vh-140px)] md:h-[605px] shrink-0 overflow-hidden">
            ...
            <div className="Section_chat_heading flex justify-center items-center w-full shrink-0">
              <div className="w-full max-w-[650px] min-w-[390px] mx-auto">
                <h1 className="Heading text-cardzzz-cream text-center font-roundo font-bold text-[24px] leading-normal">
                  final touches?
                </h1>
              </div>
            </div>
            ...
            <div
              ...
              className="Section_chat flex flex-col items-center flex-1 w-full overflow-y-auto overflow-x-hidden min-h-0 max-h-full"
              style={{
                WebkitMaskImage:
