...
export default function AuthModal({
  ...
  const inputBase =
    "PlaceholderText w-full py-[10px] px-[27px] text-cardzzz-cream font-satoshi font-normal text-[14px] leading-normal relative bg-white/10 backdrop-blur-md border border-white/20 rounded-[20px] placeholder:text-cardzzz-muted outline-none focus:border-cardzzz-cream/40 transition-colors";

  return (
    <>
      <div
        className="Comp_Auth_Backdrop fixed inset-0 w-full h-full bg-black/40 backdrop-blur-xl z-50 flex items-center justify-center p-[15px]"
      ...
      >
        <div
          className="Comp_Auth_Modal flex flex-col items-center gap-[15px] w-full max-w-[500px] pt-[30px] md:pt-[20px] pb-[30px] md:pb-[15px] pl-[30px] md:pl-[15px] pr-[30px] md:pr-[15px] rounded-[30px] bg-white/10 backdrop-blur-md border border-white/20 shadow-2xl relative z-[60]"
        ...
        >
          {onClose && (
            <button
              ...
              className="Comp_Auth_Close absolute top-[15px] right-[15px] w-[32px] h-[32px] flex items-center justify-center text-cardzzz-cream hover:opacity-70 transition-opacity cursor-pointer z-[70] p-0"
          ...
          {/* Logo - centered main header below X */}
          <div
            className="Comp_Auth_Header flex justify-center w-full mt-[32px]"
            aria-hidden
          >
            <svg
              className="Comp_Auth_Logo w-[115px] h-[36px] text-cardzzz-cream"
              viewBox="0 0 86 27"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          <div className="Comp_Auth_Toggle flex items-center gap-[8px] p-[4px] rounded-[20px] bg-white/10 border border-white/20 w-full">
            <button
              type="button"
              onClick={() => setMode("signin")}
              className={`Comp_Auth_Toggle_Option flex-1 py-[10px] px-[16px] rounded-[16px] font-roundo font-semibold text-[14px] md:text-[16px] leading-normal transition-all cursor-pointer ${
                mode === "signin"
                  ? "bg-cardzzz-cream text-cardzzz-accent"
                  : "bg-transparent text-cardzzz-cream hover:opacity-80"
              }`}
            >
              sign in
            </button>
          ...
          {error && (
            <p className="Comp_Auth_Error text-cardzzz-accent font-satoshi font-medium text-[12px] leading-normal w-full text-center">
              {error}
            </p>
          )}
          ...
          {mode === "signup" ? (
            ...
            >
              ...
              {password !== "" && confirmPassword !== "" && password !== confirmPassword && (
                <p className="Comp_Error_Text text-cardzzz-accent font-satoshi font-medium text-[12px] leading-normal w-full text-left">
              ...
              <button
                ...
                className={`Comp_Button w-full h-[54px] py-[20px] px-[10px] flex items-center justify-center gap-[10px] rounded-[16.168px] border transition-all font-roundo font-bold text-[19px] ${
                  isSignUpValid
              ...
              >
                <span className="Label text-center leading-normal relative">create account</span>
              </button>
            ...
            >
              ...
              >
                <span className="Label text-center leading-normal relative">sign in</span>
              </button>
              <div className="T_C_text w-full text-cardzzz-cream text-center font-satoshi font-normal text-[10px] leading-normal relative">
                By signing in you acknowledge that you have read and agreed to our{" "}
                <button type="button" className="underline hover:text-cardzzz-cream/80 transition-colors cursor-pointer">
                  privacy policy
                </button>{" "}
                and{" "}
